    ...
    <div class="row">
        <div class="col-md-12">
            <div class="sec-title p-15 mb-20">
                <h3>@if(isset($productEdit)) Edit Product @else Add Product @endif</h3>
            </div>
        </div>
    </div>
    {{--{{dd($categoryEdit)}}--}}
        ...
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <div class="form-group col-xs-12">
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input type="text" name="title" class="form-control"
                               ...
                               $productEdit)) value="{{$productEdit->title}}" @else value="{{old('title')}}" @endif>
                                ...
                                @if(isset($brands[0]))
                                    @foreach($brands as $brand)
                                        <option
                                                ...
                                                selected @elseif($brand->id==old('brand_id')) selected @endif >{{$brand->name}}</option>
                                    @endforeach
                                @endif
                            </select>
                                ...
                                @if(isset($categoryList[0]))
                                    @foreach($categoryList as $category)
                                        <option value="{{$category->id}}"
                                                @if(isset($productEdit) && ($category->id == $productEdit->category_id)) selected @elseif($category->id == old('category_id')) @endif>{{$category->title}}</option>
                                    @endforeach
                                @endif
                            </select>
                                ...
                                @if(isset($supplierList[0]))
                                    @foreach($supplierList as $supplier)
                                        <option value="{{$supplier->id}}"
                                                @if(isset($productEdit) && ($supplier->id == $productEdit->supplier_id)) selected @elseif($supplier->id == old('supplier_id')) @endif>{{$supplier->name}}</option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="form-group col-md-4 col-xs-12">
                        <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                            ...
                            <input type="text" name="price" class="form-control"
                                   ...
                                   @if(isset($productEdit)) value="{{$productEdit->price}}" @else value="{{old('price')}}" @endif>
                    ...
                    <div class="form-group col-md-4 col-xs-12">
                        <div class="form-group {{ $errors->has('discount') ? 'has-error' : '' }}">
                            ...
                            <input type="text" name="discount" class="form-control"
                                   ...
                                   @if(isset($productEdit)) value="{{$productEdit->discount}}" @else value="{{old('discount')}}" @endif>
                    ...
                    <div class="form-group col-md-4">
                        <div class="form-group {{ $errors->has('qty') ? 'has-error' : '' }}">
                            ...
                            <input type="text" name="qty" class="form-control"
                                   ...
                                   @if(isset($productEdit)) value="{{$productEdit->qty}}" @else value="{{old('qty')}}" @endif>
                    ...
                    <div class="form-group col-md-4">
                        <div class="form-group {{ $errors->has('sku') ? 'has-error' : '' }}">
                            ...
                            <input type="text" name="sku" class="form-control"
                                   ...
                                   @if(isset($productEdit)) value="{{$productEdit->sku}}" @else value="{{old('sku')}}" @endif>
                    ...
                    <div class="form-group col-md-12">
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea name="description" class="form-control" cols="5" rows="5"
                                      placeholder="Product Description">@if(isset($productEdit)){{$productEdit->description}}@else {{old('description')}}@endif</textarea>
                ...
                <div class="col-lg-12">
                    ...
                    @endif
                    <button type="submit" class="btn btn-info pull-right">@if(isset($productEdit))Update @else Add @endif</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
